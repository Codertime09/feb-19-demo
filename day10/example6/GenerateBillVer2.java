...
public class GenerateBillVer2 {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("******* ENTER PRODUCT LINE ITEM ********");
		for (int i = 0; i < 2; i++) {
			System.out.println("PRODUCT LINE ITEM " + (i+1));
			
			bill.append("\n");
			
			System.out.println("Enter HSN CODE");
			String hsnc = sc.nextLine();
			
			System.out.println("Enter PRODUCT");
			String pname = sc.nextLine();
			
			System.out.println("Enter MRP");
			String mrp = sc.nextLine();
			
			bill.append(String.format("|%-8.8s|", hsnc));
			bill.append(String.format("%-13.13s|", pname));
			bill.append(String.format("%-7.7s|", mrp));
